from utils.utils_google import google_jobs_scrape, merge_data
import pandas as pd
from tqdm import tqdm
import logging

logging.basicConfig(filename='logs/log_google.log',
...
if __name__=='__main__':
    ...
    for phrase in tqdm(PHRASES):
        try:
            ...
            google_df.to_csv('output/google/google_output_details.csv',index=False)
