from utils.utils_indeed import indeed_scrap,merge_data
import pandas as pd
from tqdm import tqdm
import logging

logging.basicConfig(filename='logs/log_indeed.log',
...
if __name__=='__main__':
    ...
    for indeed_link in tqdm(INDEED_LINKS):
        try:
            ...
            indeed_df.to_csv('output/indeed/indeed_output_details.csv',index=False)
