...
def monster_scrap(monster_link):
    ...
    df.to_csv(f'output/monster/data_by_location/monster_output_{monster_link["locations"]}.csv',index=False)
...
def merge_data():
    ...
    for file in csv_files:
        try:
            ...
            merged_file_path = os.path.join(new_folder_path, 'monster_full_data.csv')
