...
if __name__=='__main__':
    ...
    for linkedin_link in tqdm(LINKEDIN_LINKS):
        try:
            ...
            linkedin_df['details'][linkedin_df['links'].tolist().index(linkedin_link['links'])]='success'
            ...
            linkedin_df['details'][linkedin_df['links'].tolist().index(linkedin_link['links'])]='failed'
            linkedin_df.to_csv('output/linkedin_output_details.csv',index=False)
